...
contract UniqBonus is ERC721Tradable {
    // ----- VARIABLES ----- //
    ...
    // ----- VIEWS ----- //
    function isPrizeCollectedForAddress(address _address) external view returns(bool){
    ...
    // ----- OWNERS METHODS ----- //
    function mintAsOwner(uint _tokenNumber, address _receiver) external onlyOwner{
