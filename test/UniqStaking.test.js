...
const UniqTokenArtifact = artifacts.require("UniqToken");
const UniqStakingArtifact = artifacts.require("UniqStaking");
const UniqBonusArtifact = artifacts.require("UniqBonus");
...
contract("UniqStaking", (accounts) => {
  ...
  beforeEach(async () => {
    ...
    Collection = await UniqBonusArtifact.new(
  ...
  describe('add:', () => {
    it('create a new pool', async () => {
      ...
      let rec = await UniqStaking.addStakePool(30, amount, UniqToken.address, new BN(DAYINSEC * 10), 
        new BN(DAYINSEC * 30), "Qmc1uUGwGqCzFiA28WcA4A5ZceUdasuy3L6f2Qk8kXEyga", "Shirt", 
        {
          requiredErc20Token: UniqToken.address,
  ...
  describe('deposit:', () => {
    ...
    it('move fund to the contract', async () => {
      await UniqStaking.addStakePool(30, amount, UniqToken.address, new BN(DAYINSEC * 10), 
        new BN(DAYINSEC * 30), "Qmc1uUGwGqCzFiA28WcA4A5ZceUdasuy3L6f2Qk8kXEyga", "Shirt", 
        {
          requiredErc20Token: UniqToken.address,
          requiredErc20TokenQuantity: tokens("1000"),
    ...
    it('should check pool restriction', async () => {
      await UniqStaking.addStakePool(2, amount, UniqToken.address, new BN(DAYINSEC * 10), 
        new BN(DAYINSEC * 30), "Qmc1uUGwGqCzFiA28WcA4A5ZceUdasuy3L6f2Qk8kXEyga", "Shirt", 
        {
          requiredErc20Token: UniqToken.address,
          requiredErc20TokenQuantity: tokens("1000"),
    ...
    it('slot should be not reusable', async () => {
      let amount = new BN(Web3Utils.toWei('1000', 'ether'));
      await UniqStaking.addStakePool(30, amount, UniqToken.address, new BN(DAYINSEC * 10), 
        new BN(DAYINSEC * 1), "Qmc1uUGwGqCzFiA28WcA4A5ZceUdasuy3L6f2Qk8kXEyga", "Shirt", 
        {
          requiredErc20Token: UniqToken.address,
          requiredErc20TokenQuantity: tokens("1000"),
          requiredErc721Token: Collection.address,
  ...
  describe('withdraw:', () => {
    ...
    it('lock for 30 days', async () => {
      ...
      await UniqStaking.addStakePool(30, amount, UniqToken.address, stakeWindow, stakeLength, 
        "Qmc1uUGwGqCzFiA28WcA4A5ZceUdasuy3L6f2Qk8kXEyga", "Shirt", 
        {
          requiredErc20Token: UniqToken.address,
          requiredErc20TokenQuantity: tokens("1000"),
          requiredErc721Token: Collection.address,
    ...
    it('different fund lock period for each pool', async () => {
      let amount = new BN(Web3Utils.toWei('1000', 'ether'));
      await UniqStaking.addStakePool(30, amount, UniqToken.address, new BN(DAYINSEC * 10), 
        new BN(DAYINSEC * 1), "Qmc1uUGwGqCzFiA28WcA4A5ZceUdasuy3L6f2Qk8kXEyga", "A", 
        {
          requiredErc20Token: UniqToken.address,
          requiredErc20TokenQuantity: tokens("1000"),
          requiredErc721Token: Collection.address,
        ...
        { from: admin });
      await UniqStaking.addStakePool(30, amount, UniqToken.address, new BN(DAYINSEC * 10), 
        new BN(DAYINSEC * 2), "Qmc1uUGwGqCzFiA28WcA4A5ZceUdasuy3L6f2Qk8kXEyga", "B", 
        {
          requiredErc20Token: UniqToken.address,
          requiredErc20TokenQuantity: tokens("1000"),
          requiredErc721Token: Collection.address,
  ...
  describe('user can check list of stakes', function () {
    it('should return array of old and current stakes', async function () {
      ...
      await UniqStaking.addStakePool(30, amount, UniqToken.address, new BN(DAYINSEC * 10), 
        new BN(DAYINSEC), "Qmc1uUGwGqCzFiA28WcA4A5ZceUdasuy3L6f2Qk8kXEyga", "Shirt", 
        {
          requiredErc20Token: UniqToken.address,
          requiredErc20TokenQuantity: tokens("1000"),
          requiredErc721Token: Collection.address,
      ...
      await UniqStaking.addStakePool(30, amount, UniqToken.address, new BN(DAYINSEC * 10), 
        new BN(DAYINSEC * 5), "Qmc1uUGwGqCzFiA28WcA4A5ZceUdasuy3L6f2Qk8kXEyga", "Shirt", 
        {
          requiredErc20Token: UniqToken.address,
          requiredErc20TokenQuantity: tokens("1000"),
          requiredErc721Token: Collection.address,
